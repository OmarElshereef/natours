...
const tourSchema = new mongoose.Schema(
    {
        ...
        createdAt: {
            type: Date,
            default: Date.now(),
            select: false, // to make it never get selected in the query
        },
        startDates: [Date],
        secretTour: {
            type: Boolean,
...
tourSchema.virtual('durationWeeks').get(function () {
    return this.duration / 7; // a normal function and not an arrow function because we need 'this' keyword
});
